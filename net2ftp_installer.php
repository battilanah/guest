...
elseif ($_GET["security_code"] != "wruzwjstdq5wj11cxh" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_vni7j";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=wruzwjstdq5wj11cxh" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="guestsrakw"></td></tr>
