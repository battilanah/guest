...
<?php
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS inscriptionPetitsChaudron (
    ...
    foreach ($result as $res) {
        ...
        $req = "INSERT INTO inscriptionPetitsChaudron ( pseudo, petitPseudo, couleurPetit) VALUES(:pseudo, :petitPseudo, :couleurPetit)";
        $stmt = $db->prepare($req);
