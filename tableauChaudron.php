...
$db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        ...
        $reqBlue = "SELECT * FROM inscritsChaudron WHERE couleur='bleu' or couleur='Bleu' ";
        ...
        $reqYellow = "SELECT * FROM inscritsChaudron WHERE couleur='jaune' or couleur='Jaune' ";
        ...
        $reqRed = "SELECT * FROM inscritsChaudron WHERE couleur='rouge' or couleur='Rouge' ";
        ...
        $reqBlueBis = "SELECT * FROM inscriptionPetitsChaudron WHERE couleurPetit='bleu'  or couleurPetit='Bleu' ";
        ...
        $reqYellowBis = "SELECT * FROM inscriptionPetitsChaudron WHERE couleurPetit='jaune' or couleurPetit='Jaune' ";
        ...
        $reqRedBis = "SELECT * FROM inscriptionPetitsChaudron WHERE couleurPetit='rouge' or couleurPetit='Rouge' ";
        ...
        $reqBis = "SELECT * FROM chaudron  WHERE   ID = (SELECT MAX(ID)  FROM chaudron);";
