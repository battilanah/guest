...
$db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        ...
        $reqBlue = "SELECT * FROM inscritsPrincesse WHERE couleur='bleu' or couleur='Bleu' ";
        ...
        $reqYellow = "SELECT * FROM inscritsPrincesse WHERE couleur='jaune' or couleur='Jaune' ";
        ...
        $reqRed = "SELECT * FROM inscritsPrincesse WHERE couleur='rouge' or couleur='Rouge' ";
        ...
        $reqBlueBis = "SELECT * FROM inscriptionPetitsPrincesse WHERE couleurPetit='bleu'  or couleurPetit='Bleu' ";
        ...
        $reqYellowBis = "SELECT * FROM inscriptionPetitsPrincesse WHERE couleurPetit='jaune' or couleurPetit='Jaune' ";
        ...
        $reqRedBis = "SELECT * FROM inscriptionPetitsPrincesse WHERE couleurPetit='rouge' or couleurPetit='Rouge' ";
        ...
        $reqBis = "SELECT * FROM princesse  WHERE   ID = (SELECT MAX(ID)  FROM princesse);";
