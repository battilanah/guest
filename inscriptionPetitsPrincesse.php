...
$db->exec("CREATE TABLE IF NOT EXISTS inscriptionPetitsPrincesse (
...
foreach ($result as $res) {
    ...
    foreach ($row as $resBis) {
        ...
        $req = "INSERT INTO inscriptionPetitsPrincesse ( name, petitPseudo, couleurPetit) VALUES(:name, :petitPseudo, :couleurPetit)";
        $stmt = $db->prepare($req);
