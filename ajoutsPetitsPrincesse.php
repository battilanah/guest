...
<form  action="inscriptionPetitsPrincesse.php" method="post" id="myForm"  >
...
<p>si vous ne souhaitez pas ajouter de petit compte, cliquez ici:</p>
<button onclick="session()"> revenir à ma session</button>
